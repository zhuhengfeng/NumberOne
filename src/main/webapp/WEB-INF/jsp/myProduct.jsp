...
<head profile="http://www.w3.org/2005/10/profile">
  ...
  <link rel='stylesheet' href='${pageContext.request.contextPath}/css/all_1.css' type='text/css' media='screen' />
  <script src='${pageContext.request.contextPath}/js/all_1.js' type='text/javascript'></script>
  <link rel='stylesheet' href='${pageContext.request.contextPath}/css/style_2.css' type='text/css' media='screen' />
  <link rel='stylesheet' href='${pageContext.request.contextPath}/css/style_3.css' type='text/css' media='screen' />
  <style>.box h4.title
  {
    font-size: 24px;
...
<div class='page-container'>
  ...
  <div class='page-wrapper'>
    <div class='page-content'>
      ...
      </li><li>产品介绍</li></ul><div class='row'>
      <div class='col-md-12'>
        <div class='article'>
                      ...
                      <tbody>
                        <c:forEach items="${products}" var="product" varStatus="vs">
                          <tr>
                            <td>${vs.count}</td>
                            <td>${product.pname}</td>
                            <td><img width="150px" height="150px"  src="${pageContext.request.contextPath}/${product.pimage}" alt="无法显示"> </td>
                            <td>${product.market_price} </td>
                            <td><button id="add-btn" type="button" onclick="addcart(${product.pid})">加入购物车</button></td>
...
<div class='hide'><div id="block23" class='panel panel-block ' >
  ...
  <div class='panel-body'>
    <div class='article-content'><div class="hidden">
      ...
      <script src="${pageContext.request.contextPath}/js/z_stat_1.js" language="JavaScript"></script>
    </div></div>
  </div>
</div>
  <style>#block23{}#block23 .panel-heading{}</style><div id="block25" class='panel panel-block ' >
    ...
    <div class='panel-body'>
      <div class='article-content'><br />
        ...
        <script language="javascript" type="text/javascript">var _kc_userID="227697";</script><script language="JavaScript" type="text/javascript" src="${pageContext.request.contextPath}/js/stat_1.js"></script></div>
    </div>
  </div>
...
//          debugger;
            ...
            console.log(pid)
            $.post(
              '${pageContext.request.contextPath}/product/addcart/'+pid,
              pid,
              function (rec) {
                  if(rec==0){
                      alert("请登录!");
